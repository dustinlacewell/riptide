...
const PROJECTS = [
  ...
  dir("atlas", [
    ...
    // A workspace: its packages share the one node_modules at the top.
    dir("packages", [
      dir("web", [leaf("dist", 40, 120),
        leaf(".next", 180, 1300, { junk: "cache-safe", label: "Next.js build cache" }), src(12)]),
      dir("api", [leaf("dist", 44, 90), src(9)]),
      dir("shared", [leaf("dist", 41, 60), src(4)]),
      dir("cli", [leaf("dist", 52, 40), src(3)]),
    ]),
    git(330),
  ], { age: 12 }),
  dir("tide-api", [
  ...
  dir("api-gateway", [leaf("dist", 60, 80), src(14), git(70)], { age: 8 }),
  dir("docs-site", [leaf("dist", 112, 900), src(18), git(60)], { age: 40 }),
  ...
  dir("wasm-demo", [leaf("target", 540, 3100), leaf("dist", 40, 20)], { age: 180 }),
